...
public class PublishConfigFilterPathext implements PublishConfigFilter {

	private CmsItemClassification itemClassification = new CmsItemClassificationXml();
	...
	public boolean accept(PublishConfig config, CmsItem item) {
		...
		return itemClassification.isXml(item.getId());
	}
